...
public class ConexionBD {
    ...
    public ConexionBD(){
        ...
        puerto = "20480";
        this.url = "jdbc:mysql://" + host + ":" + puerto + "/" + nombreBD + "?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC";
        try {
...
public boolean borrarBD (String sentenciaSQL){
 ...
 //funcion para confiar o negar el autoguardado en la base de datos
    ...
    public void cerrarConexion(){this.closeConnection(this.connection);}
